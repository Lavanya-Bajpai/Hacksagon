...
import * as userService from '../../../contexts/services/auth.service';
import { auth } from '../../../contexts/services/firebase/config';
  ...
  useEffect(() => {
    const checkUserProfile = async () => {
      ...
      try {
        ...
        const profile = await userService.getUserData(currentUser.uid);
        ...
        if (!profile) {
          ...
          await userService.saveUserData(defaultProfile.uid, defaultProfile);
