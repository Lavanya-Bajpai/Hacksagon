      ...
      <div className="flex h-screen">
        ...
        <div className="w-20 lg:w-64 bg-black/40 backdrop-blur-md text-white flex flex-col border-r border-[#f5e1a0]/20">
          <div className="p-4 flex items-center justify-center lg:justify-start font-serif">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-br from-[#f5e1a0] to-[#ffe066] rounded-lg flex items-center justify-center text-[#181e26] font-bold text-sm shadow-lg">
              ...
              <div className="hidden lg:flex flex-col">
                <span className="text-lg font-semibold text-[#f5e1a0] leading-tight">Nagrik Aur</span>
                <span className="text-lg font-semibold text-white leading-tight">Samvidhan</span>
              </div>
              <span className="lg:hidden text-xl font-semibold text-[#f5e1a0]">NAS</span>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col h-screen overflow-y-auto">
          ...
          <div className="p-4 text-center text-white text-sm bg-black/30 backdrop-blur-sm border-t border-[#f5e1a0]/20">
            Experience the principles of democracy with Nagrik Aur Samvidhan. Explore historical documents and learn about the foundation of our nation.
          </div>
        </div>
      </div>
    </div>
